...
function createSelect() {
    $('.hour-select').each(function () {
        for (var i = 0; i < 24; i++) {
            ...
            $(this).append('<option>' + i + ":30</option>");
        }
        $(this).comboSelect();
    });
    $('.hour-select').each(function () {
        $(this).parent().find('input.combo-input').addClass('default-control');
        $(this).parent().find('input.combo-input').attr('name', $(this).attr('data-name'));
        $(this).parent().find('input.combo-input').attr('placeholder', $(this).attr('data-placeholder'));
        $(this).parent().find('input.combo-input').val(null);
        $(this).parent().find('input.combo-input').prop('required', $(this).prop('required'));
    ...
    $('.number-select').each(function () {
        ...
        $(this).parent().find('input.combo-input').attr('name', $(this).attr('data-name'));
        $(this).parent().find('input.combo-input').attr('placeholder', $(this).attr('data-placeholder'));
        $(this).parent().find('input.combo-input').attr('min', $(this).attr('data-min'));
        $(this).parent().find('input.combo-input').attr('max', $(this).attr('data-max'));
        $(this).parent().find('input.combo-input').val(null);
        $(this).parent().find('input.combo-input').prop('required', $(this).prop('required'));
    });
    $('.product-select').each(function () {
        for (var i = 1; i <= 10; i++) {
            $(this).append('<option>' + "Sản phẩm " + i + "</option>");
        }
        $(this).comboSelect();
    });
    $('.product-select').each(function () {
    ...
    $('select.combo-select').each(function () {
        $(this).comboSelect();
    });
    ...
    $('input.combo-input').focus(function () {
        if ($('ul.combo-dropdown li').length >= 6) {
            $('ul.combo-dropdown').css('height', 200);
            $('ul.combo-dropdown').customScrollbar();
        }
    });
